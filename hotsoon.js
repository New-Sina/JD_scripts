...
function sign_in() {
    return new Promise((resolve, reject) => {
        let sign_inurl = {
            url: `https://ib-hl.snssdk.com/luckycat/hotsoon/v1/task/sign_in_detail?${hotsoonsignheader}`,
...
function profit() {
    return new Promise((resolve, reject) => {
        let profiturl = {
            url: `https://i-hl.snssdk.com/luckycat/hotsoon/v1/wallet/profit_detail_page?&aid=1350&pro_type=score&polaris_version=2.0.0&${hotsoonsignheader}&income_type=1&offset=0&num=20&_request_from=web&${hotsoonsignheader}`,
            headers: JSON.parse(hotsoonsignkey),
        }
